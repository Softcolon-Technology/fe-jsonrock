...
- **How it Works**:
  ...
  - **Broadcasting**: The custom Node.js server (`server.ts`) listens for these events and broadcasts the new code to _everyone else_ in that room, excluding the sender. This prevents cursor jumping and race conditions.
